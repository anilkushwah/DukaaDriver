...
public class TotalEarnModel {
    ...
    @SerializedName("incorporation_certificate")
    @Expose
    ...
    public String getIsRegisteredSuccessfully() {
        return isRegisteredSuccessfully;
    }

    public void setIsRegisteredSuccessfully(String isRegisteredSuccessfully) {
